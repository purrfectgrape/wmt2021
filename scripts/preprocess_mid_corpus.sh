...
python3 scripts/extract_wikimatrix_orig.py --tsv $BASE/data/wikimatrix-en-ja.tsv.gz --src-lang en --trg-lang ja --threshold 1.0 --bitext $BASE/data/raw/wikimatrix.en-ja.txt
